...
riot$1.tag2('app', '<h1>Weather Information</h1> <section> <weather city="Tokyo" apikey="{apikey}"></weather> <weather city="Ome" apikey="{apikey}"></weather> <weather city="Hachioji" apikey="{apikey}"></weather> </section><br> <section> <weather city="Tachikawa" apikey="{apikey}"></weather> <weather city="Chofu" apikey="{apikey}"></weather> </section>', 'app,[data-is="app"]{ display: block; padding: 2em; } app h1,[data-is="app"] h1{ border-bottom: 1px solid purple; color: purple; font-size: 130%; font-weight: normal; padding-bottom: .3em; margin: 0 0 .5em; } app section,[data-is="app"] section{ display: flex; flex-wrap: wrap; justify-content: space-between; } app section > *,[data-is="app"] section > *{ flex-basis: 7em; flex-grow: 1; margin: .5em; }', '', function(opts) {
    this.apikey = '363114a85cbadec206cb71e40a30097b';
});

riot$1.tag2('weather', '<header> <i class="{weatherClass}"></i> <span>{city || \'loading...\'}</span> </header> <ul> <li>{description}</li> <li>{temp}&#8451;</li> </ul>', 'weather,[data-is="weather"]{ border: 1px solid purple; border-radius: .5em; color: purple; display: block; margin-bottom: 1em; overflow: hidden; text-align: center; } weather header,[data-is="weather"] header{ background: purple; color: white; padding: 1em 0 .8em; } weather header > i,[data-is="weather"] header > i{ display: block; font-size: 300%; } weather header > span,[data-is="weather"] header > span{ display: block; margin-top: .5em; } weather ul,[data-is="weather"] ul{ list-style: none; margin: 0; padding: 0; } weather ul > li,[data-is="weather"] ul > li{ height: 1em; font-size: 34px; margin: auto; overflow: hidden; padding: .4em .5em; text-overflow: ellipsis; white-space: nowrap; } weather ul > li:not(:last-child),[data-is="weather"] ul > li:not(:last-child){ border-bottom: 1px dotted purple; }', '', function(opts) {
    var this$1 = this;

    var apiBase = 'http://api.openweathermap.org/data/2.5/weather';
    var appid = opts.apikey;
    var url = apiBase + "?q=" + (opts.city) + "&APPID=" + appid + "&units=metric";
